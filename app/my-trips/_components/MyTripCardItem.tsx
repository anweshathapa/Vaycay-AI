...
function MyTripCardItem({trip}:Props) {
  ...
  return (
       ...
       <Link href= {'/view-trip/'+ trip?.tripId }className='p-5 shadow rounded-2xl '>
                {/* <Image src = {photoUrl ? photoUrl : '/placeholder.jpeg'} alt = {trip.tripId} width={400} height = {400} */}
                <Image src= {(photoUrl && photoUrl.length > 0) ? photoUrl : '/placeholder.jpeg'} alt = {trip.tripId} width={400} height = {400}
                className='rounded-xl object-cover w-full h-67.5'/>
